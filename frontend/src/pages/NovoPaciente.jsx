...
function NovoPaciente() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        criarUtilizador:
          formData.dependente === false && formData.enviarCredenciais === true,
        enviarCredenciais:
          formData.dependente === false && formData.enviarCredenciais === true,
      };
  ...
  const selectResponsavel = (paciente) => {
    ...
    setResponsavelSearch(
      `${paciente.nomeCompleto} - ${paciente.numeroUtente || "N/A"}`
    );
  ...
  const getSelectedResponsavelDisplay = () => {
    if (formData.responsavelId) {
      const selected = pacientes.find(
        (p) => p.id.toString() === formData.responsavelId
      );
      if (selected) {
              ...
              <div className="toggle-buttons">
                <button
                  ...
                  className={`toggle-btn ${
                    formData.dependente === true ? "active" : ""
                  }`}
                ...
                <button
                  type="button"
                  className={`toggle-btn ${
                    formData.dependente === false ? "active" : ""
                  }`}
                ...
                <div className="conditional-field">
                  ...
                  <div className="toggle-buttons">
                    <button
                      type="button"
                      className={`toggle-btn ${
                        formData.enviarCredenciais === true ? "active" : ""
                      }`}
                    ...
                    <button
                      type="button"
                      className={`toggle-btn ${
                        formData.enviarCredenciais === false ? "active" : ""
                      }`}
                        ...
                        {filteredPacientes.length === 0 ? (
                          ...
                          filteredPacientes.map((p) => (
                            ...
                            >
                              ...
                              <span className="dropdown-nus">
                                NUS: {p.numeroUtente || "N/A"}
                              </span>
                            </button>
                          ))
                        )}
